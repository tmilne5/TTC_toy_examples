...
def critic_trainer(critic_list, optimizer_list, iteration, steps, target_loader, source_loader, args):
    ...
    for i in range(args.critters):
        ...
        gradient_penalty = calc_gradient_penalty(critic_list[iteration], real, fake, args.lamb)
        ...
        log.plot('d_cost',  D_cost.cpu().data.numpy())  # correction applied
